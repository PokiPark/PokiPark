...
public class AdminSettingsController extends RegisterController implements Initializable {
	...
	@FXML
	private Button settingsSpecified_B1, settingsSpecified_B2, contentPane_B1, contentPane_B3, contentPane_B4,
			contentPane_B5, contentPane_B6, contentPane_B7, contentPane_B8;
	...
	private void contentPane_AddEntryToUserList() {
		...
		if (!settingsSpecified_TF.getText().toString().equals(""))
